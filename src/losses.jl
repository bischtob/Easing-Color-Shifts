"""
    EasingColorShifts.vanilla_score_matching_loss(model::AbstractDiffusionModel, x_0; ϵ=1.0f-5, c=nothing)
...
"""
    EasingColorShifts.score_matching_loss(model::AbstractDiffusionModel, x_0; ϵ=1.0f-5, c= nothing)
