...
"""
    EasingColorShifts.DenoisingDiffusionNetwork
...
"""
    EasingColorShifts.ResnetBlockDDN
...
"""
    EasingColorShifts.ResnetBlockNCSN
...
"""
    EasingColorShifts.AttentionBlock
...
"""
    EasingColorShifts.compute_attention_weights(keys, queries, Val{nspatialdims})
...
"""
    EasingColorShifts.apply_attention_weights(weights, values, Val{nspatialdims})
...
"""
    EasingColorShifts.Downsampling(channels::Pair, nspatial::Int; factor::Int=2, kernel_size::Int=3)
...
"""
    EasingColorShifts.Upsampling(channels::Pair, nspatial::Int; factor::Int=2, kernel_size::Int=3)
